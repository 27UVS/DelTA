...
class InterfaceSettingsPage(QWidget):
    def __init__(self, storage: Storage, on_apply):
        ...
        _label_texts = ("Цвет фона:", "Фон-картинка:", "Подзадач в строке:")
        ...
        form_grid.addWidget(lbl_bg, 0, 0)
        form_grid.addWidget(bg_wrap, 0, 1)
        ...
        form_grid.addWidget(lbl_img, 1, 0)
        form_grid.addWidget(img_wrap, 1, 1)
        ...
        form_grid.addWidget(lbl_sub, 2, 0)
        form_grid.addWidget(self.subtasks_per_row_spin, 2, 1, alignment=Qt.AlignmentFlag.AlignLeft)
    ...
    def refresh_after_theme_change(self) -> None:
        # Theme switching is disabled (dark only). Background preview is driven by color/path; refresh is cached.
